			...
			<div className={styles.root}>
				...
				<div className={styles.info}>
					...
					<Flex className={styles.tags}>
						<Flex.Item>
							<span className={[styles.tag, styles.tag1].join(' ')}>随时看房</span>
						</Flex.Item>
					</Flex>
				...
				<div className={styles.about}>
					...
					<HousePackage list={['电视', '冰箱', '洗衣机', '空调', '热水器', '沙发', '衣柜', '天然气']} />
				...
				<div className={styles.set}>
					...
					<div>
						...
						<div className={styles.descText}>
							{/* {description || '暂无房屋描述'} */}
							1.周边配套齐全，地铁四号线陶然亭站，交通便利，公交云集，距离北京南站、西站都很近距离。 2.小区规模大，配套全年，幼儿园，体育场，游泳馆，养老院，小学。 3.人车分流，环境优美。
				...
				<div className={styles.recommend}>
					...
					<div className={styles.items}>
						{recommendHouses.map(item => <HouseItem {...item} key={item.id} />)}
					</div>
				</div>
				...
				<Flex className={styles.fixedBottom}>
					<Flex.Item>
						<img src={BASE_URL + '/img/unstar.png'} className={styles.favoriteImg} alt="收藏" />
