...
export default class RentAdd extends Component {
	...
	render() {
		...
		const { community, price, roomType, floor, oriented, description, tempSlides, title } = this.state;
		...
		return (
			<div className={styles.root}>
				...
				<List className={styles.title} renderHeader={() => '房屋标题'} data-role="rent-list">
					<InputItem placeholder="请输入标题（例如：整租 小区名 2室 5000元）" value={title} />
				</List>
				...
				<List className={styles.desc} renderHeader={() => '房屋描述'} data-role="rent-list">
					<TextareaItem rows={5} placeholder="请输入房屋描述信息" autoHeight value={description} />
				</List>
